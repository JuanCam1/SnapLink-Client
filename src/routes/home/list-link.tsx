...
const data: LinkModelI[] = [
  ...
  },
  {
    ...
    userId: "1",
    time: 0,
    createdAt: new Date("2023-10-30T12:00:00Z"),
    state: {
      id: 1,
      name: "Active",
    },
            ...
            <div className="flex-1">
              <Table className="lg:max-w-[1200px] mt-6">
                <Table.THeader>
                  ...
                  <Table.ThCell className="lg:w-[15%]">
                    Fecha Expiración
                  </Table.ThCell>
                ...
                <Table.TBody>
                  {data.map((item) => (
                    <Table.TRow key={item.id}>
                      ...
                      <Table.TdCell dataLabel="Fecha Expiración">
                        {formatDate(item.createdAt)}
                      </Table.TdCell>
                      <Table.TdCell dataLabel="Tiempo">
                        {item.time}
                      </Table.TdCell>
