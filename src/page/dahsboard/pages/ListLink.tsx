                ...
                links.map((link) => (
                  <TableRow key={link.id}>
                    ...
                    <TableCell className="flex gap-2">
                      <button onClick={() => deleteDocument(link.id)} type="button" className="border-gray-300 dark:border-zinc-800 bg-white hover:dark:bg-zinc-900 hover:bg-zinc-100 dark:bg-zinc-800 px-4 py-2 border rounded-md text-black dark:text-white transform transition duration-300 cursor-pointer ease-in-out group hover:scale-105">
                        <Trash2 className="h-5 text-red-400" />
                      </button>
                      <button onClick={() => copyToClipboard(link.newUrl)} type="button" className="border-gray-300 dark:border-zinc-800 bg-white hover:dark:bg-zinc-900 hover:bg-zinc-100 dark:bg-zinc-800 px-4 py-2 border rounded-md text-black dark:text-white transform transition duration-300 cursor-pointer ease-in-out group hover:scale-105">
